...
public class GameHandler_Setup : MonoBehaviour {
    ...
    private void Update() {
        if (Input.GetMouseButtonDown(0)) {
            //DashEffect.CreateDashEffect(Vector3.zero, (UtilsClass.GetMouseWorldPosition() - Vector3.zero).normalized, Vector3.Distance(Vector3.zero, UtilsClass.GetMouseWorldPosition()));
        }
    }
